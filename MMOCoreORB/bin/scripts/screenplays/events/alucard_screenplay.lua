alucard_screenplay = ScreenPlay:new {
        numberOfActs = 1,

        screenplayName = "alucard_screenplay",
}

registerScreenPlay("alucard_screenplay", true)

function alucard_screenplay:start()
	if (isZoneEnabled("tatooine")) then
		self:spawnMobiles()
	end
end

function alucard_screenplay:spawnMobiles()
  local pNpc = spawnMobile("tatooine", "alucard_boss", 1200, 0.1, 0.5, -2.2, 179, 1845354)
